...
var EventsIDToParams = map[int32][]external.ArgMeta{
	...
	WriteForbiddenAlertEventID: {{Type: "alert_t", Name: "alert"}, {Type: "const char*", Name: "pathname"}, {Type: "dev_t", Name: "dev"}, {Type: "unsigned long", Name: "inode"}},
	IpChangedAlertEventID:      {{Type: "const char*", Name: "operation"}, {Type: "const char*", Name: "ip_address"}, {Type: "const char*", Name: "interface"}, {Type: "unsigned int", Name: "prefix_len"}},
	SchedProcessExitEventID:    {},
