...
// PrintIPChangeAction prints the IP change action (add/delete)
func PrintIPChangeAction(action uint32) string {
	switch action {
	case 1:
		return "IP_ADDED"
	case 2:
...
// PrintIPv4Address converts a u32 IP address (network byte order) to dotted-decimal string
func PrintIPv4Address(ipRaw uint32) string {
